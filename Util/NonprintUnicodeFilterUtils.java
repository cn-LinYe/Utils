...
public class NonprintUnicodeFilterUtils{
	private static NonprintUnicodeFilterUtils instance = new NonprintUnicodeFilterUtils();
	private final Logger log = LoggerFactory.getLogger(getClass());
	private NonprintUnicodeFilterUtils(){
		super();
	}
	
	public static NonprintUnicodeFilterUtils getInstance(){
		return instance;
	}
